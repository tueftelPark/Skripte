...
set "TARGET=%USERPROFILE%\Desktop\ArduinoEinfuehrung"
...
if exist "%TARGET%" (
    echo [+] Loesche alten "ArduinoEinfuehrung"-Ordner...
    rd /s /q "%TARGET%" 2>nul
    if exist "%TARGET%" (
...
git clone https://github.com/tueftelPark/ArduinoEinfuehrung.git
cd "%TARGET%"
start .
exit