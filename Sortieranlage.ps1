...
$TargetPath = Join-Path $Desktop 'Sortieranlage'
$ZipPath    = Join-Path $Desktop 'Sortieranlage.zip'
$ZipUrl     = 'https://github.com/tueftelPark/Sortieranlage/archive/refs/heads/main.zip'

Write-Host "==============================="
Write-Host "  Sortieranlage aktualisieren"
Write-Host "==============================="
...
$Unzip = Join-Path $Desktop 'Sortieranlage-main'
if (Test-Path $Unzip) {
    Rename-Item $Unzip 'Sortieranlage' -Force
}
