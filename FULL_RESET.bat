...
echo [2/9] Lade Skripte-Repository von GitHub herunter...
...
echo [3/9] Erstelle Webseiten-Verknuepfungen...
...
echo.
echo [5/9] Pruefe auf alte Arduino Installation...
...
echo.
echo [6/9] Ermittle aktuellste Arduino IDE Version...
...
:: --- 7. INSTALLATION ---
echo.
echo [7/9] Installiere Arduino IDE im Hintergrund...
...
echo [8/9] Pruefe Arduino-Installation und Desktop-Verknuepfung...
